...
class MovingState : IState
{
    ...
    public void Exit()
    {
        controller.Interactions.StoppingDistance = controller.Stats.CurrentAttackRange;
    }
    ...
    public void OnUpdate()
    {
        ...
        if (controller.Interactions.HasATarget)
        {
            ...
            else if(distance > controller.Stats.CurrentAttackRange)
                controller.Interactions.MoveTowardsAnExistingTarget(controller.Interactions.Target, controller.Stats.CurrentAttackRange);
        }
