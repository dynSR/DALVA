...
public class DamagePopupLogic : MonoBehaviour
{
    ...
    public static DamagePopupLogic Create(Vector3 position, GameObject damagePopUpGameObject, float damageValueToGet, DamageType damageType)
    {
        GameObject damagePopUpInstance = Instantiate(damagePopUpGameObject, position, damagePopUpGameObject.transform.rotation);

        DamagePopupLogic damagePopUp = damagePopUpInstance.GetComponent<DamagePopupLogic>();
